...
export default {
    ...
    methods: {
        ...
        login() {
            ...
            this.loginNow(this.account).then(res => {
                 console.log(res)
                 this.$util.setStorage('session', 'userName', JSON.stringify(res.userName))
                 this.$util.setStorage('session', 'role', JSON.stringify(res.role))
                 this.$util.setStorage('session', 'loginState', JSON.stringify('true'))
