...
var useInfiniteScroll = function useInfiniteScroll(service, options) {
  ...
  var scrollMethod = function scrollMethod() {
    ...
    var scrollTop = (0, rect_1.getScrollTop)(el);
    var scrollHeight = (0, rect_1.getScrollHeight)(el);
    var clientHeight = (0, rect_1.getClientHeight)(el);
    if (scrollHeight - scrollTop <= clientHeight + threshold) {
      loadMore();
    }
  };
  (0, useEventListener_1["default"])('scroll', function () {
  ...
  return {
    ...
    noMore: noMore,
    loadMore: (0, useMemoizedFn_1["default"])(loadMore),
    loadMoreAsync: (0, useMemoizedFn_1["default"])(loadMoreAsync),
