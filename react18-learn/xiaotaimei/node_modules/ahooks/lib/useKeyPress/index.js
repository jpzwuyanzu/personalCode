...
function genKeyFormatter(keyFilter, exactMatch) {
  ...
  if ((0, utils_1.isString)(keyFilter) || (0, utils_1.isNumber)(keyFilter)) {
...
function useKeyPress(keyFilter, eventHandler, option) {
  ...
  var eventHandlerRef = (0, useLatest_1["default"])(eventHandler);
  var keyFilterRef = (0, useLatest_1["default"])(keyFilter);
  (0, useDeepCompareWithTarget_1["default"])(function () {
    var e_2, _a;
    var _b;
    var el = (0, domTarget_1.getTargetElement)(target, window);
    if (!el) {
      return;
    }
