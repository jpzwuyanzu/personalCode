...
var useAntdTable = function useAntdTable(service, options) {
  ...
  var result = (0, usePagination_1["default"])(service, __assign({
    manual: true
  }, rest));
  ...
  var _g = __read((0, react_1.useState)((cacheFormTableData === null || cacheFormTableData === void 0 ? void 0 : cacheFormTableData.type) || defaultType), 2),
    type = _g[0],
    setType = _g[1];
  var allFormDataRef = (0, react_1.useRef)({});
  var defaultDataSourceRef = (0, react_1.useRef)([]);
  ...
  return __assign(__assign({}, result), {
    tableProps: {
      ...
      onChange: (0, useMemoizedFn_1["default"])(onTableChange),
      pagination: {
    ...
    search: {
      submit: (0, useMemoizedFn_1["default"])(submit),
      type: type,
      changeType: (0, useMemoizedFn_1["default"])(changeType),
