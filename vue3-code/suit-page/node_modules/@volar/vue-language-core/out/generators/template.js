...
exports.getPatchForSlotNode = exports.walkElementNodes = exports.generate = exports.isIntrinsicElement = void 0;
    ...
    function writeProps(node, format, mode) {
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                writePropName(propName, true, [prop.loc.start.offset, prop.loc.start.offset + attrNameText.length], Object.assign(Object.assign({}, getCaps(capabilitiesSet.attr)), { rename: {
                        normalize: shared_1.camelize,
