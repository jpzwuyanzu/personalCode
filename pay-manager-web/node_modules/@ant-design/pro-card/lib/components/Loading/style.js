...
var genProStyle = function genProStyle(token) {
  ...
  }, (0, _defineProperty2.default)(_token$componentCls, "".concat(token.componentCls, "-loading-content"), {
    width: '100%',
    p: {
      marginBlock: 0,
      marginInline: 0
    }
  }), (0, _defineProperty2.default)(_token$componentCls, "".concat(token.componentCls, "-loading-block"), {
    height: '14px',
    marginBlock: '4px',
