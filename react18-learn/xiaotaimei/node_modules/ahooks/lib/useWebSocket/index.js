...
function useWebSocket(socketUrl, options) {
  ...
  var onOpenRef = (0, useLatest_1["default"])(onOpen);
  var onCloseRef = (0, useLatest_1["default"])(onClose);
  var onMessageRef = (0, useLatest_1["default"])(onMessage);
  var onErrorRef = (0, useLatest_1["default"])(onError);
  var reconnectTimesRef = (0, react_1.useRef)(0);
  var reconnectTimerRef = (0, react_1.useRef)();
  var websocketRef = (0, react_1.useRef)();
  var unmountedRef = (0, react_1.useRef)(false);
  var _d = __read((0, react_1.useState)(), 2),
    latestMessage = _d[0],
    setLatestMessage = _d[1];
  var _e = __read((0, react_1.useState)(ReadyState.Closed), 2),
    readyState = _e[0],
    setReadyState = _e[1];
  ...
  return {
    ...
    sendMessage: (0, useMemoizedFn_1["default"])(sendMessage),
    connect: (0, useMemoizedFn_1["default"])(connect),
    disconnect: (0, useMemoizedFn_1["default"])(disconnect),
