...
var useFusionTable = function useFusionTable(service, options) {
  ...
  var ret = (0, useAntdTable_1["default"])(service, __assign(__assign({}, options), {
    form: options.field ? (0, fusionAdapter_1.fieldAdapter)(options.field) : undefined
  }));
  return (0, fusionAdapter_1.resultAdapter)(ret);
};
