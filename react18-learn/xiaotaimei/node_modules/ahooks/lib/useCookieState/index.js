...
function useCookieState(cookieKey, options) {
  ...
  var _a = __read((0, react_1.useState)(function () {
      ...
      if ((0, utils_1.isString)(cookieValue)) return cookieValue;
    ...
    state = _a[0],
    setState = _a[1];
  var updateState = (0, useMemoizedFn_1["default"])(function (newValue, newOptions) {
    ...
    setState(function (prevState) {
      var value = (0, utils_1.isFunction)(newValue) ? newValue(prevState) : newValue;
      if (value === undefined) {
