...
export default () => {
  ...
  const rowRefresh = async (record, key) => {
    const loadingKey = `${key}-${record.tunnelId}`;
    try {
      setLoadingMap((prevState) => ({ ...prevState, [loadingKey]: true }));
      const { balance, tunnelBalance } = await services.channel.getTunnelBalance(record.tunnelId);
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 180,
      render: (text, record) => {
        return /* @__PURE__ */ React.createElement(Space, null, /* @__PURE__ */ React.createElement("span", null, text), /* @__PURE__ */ React.createElement(ReloadOutlined, { spin: loadingMap[`balance-${record.tunnelId}`], onClick: async () => {
    ...
    },
    {
      ...
      width: 180,
      render: (text, record) => {
        return /* @__PURE__ */ React.createElement(Space, null, /* @__PURE__ */ React.createElement("span", null, text), /* @__PURE__ */ React.createElement(ReloadOutlined, { spin: loadingMap[`tunnelBalance-${record.tunnelId}`], onClick: async () => {
          await rowRefresh(record, "tunnelBalance");
        } }));
      },
      sorter: (a, b) => a.tunnelBalance - b.tunnelBalance
    },
    {
      title: "\u4ECA\u65E5\u4EE3\u4ED8\u91D1\u989D",
      dataIndex: "usedMoney",
      hideInForm: true,
      hideInSearch: true,
      sorter: (a, b) => a.usedMoney - b.usedMoney
    },
    {
      title: "\u4ECA\u65E5\u4E0A\u6E38\u624B\u7EED\u8D39",
      dataIndex: "upFee",
    ...
    },
    {
      ...
      hideInForm: true,
      hideInSearch: true,
      sorter: (a, b) => a.merchantFee - b.merchantFee
    },
    {
      title: "\u5355\u7B14\u6700\u5C0F\u9650\u989D",
      dataIndex: "min",
    ...
    },
    {
      ...
      hideInSearch: true,
      sorter: (a, b) => a.dailyQuota - b.dailyQuota
    },
    {
      title: "\u901A\u9053\u5E01\u79CD",
      dataIndex: "currency",
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    TablePage,
    {
      ...
      toolBarActions: () => {
        return [
          /* @__PURE__ */ React.createElement(BalanceRecordModal, { key: "balance", type: ChannelTypeEnum.Payment })
        ];
      },
      actions: (record) => {
