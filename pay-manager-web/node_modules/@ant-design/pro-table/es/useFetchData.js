...
var useFetchData = function useFetchData(getData, defaultData, options) {
        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            return Promise.race([fetchList(isPolling), new Promise(function (_, reject) {
              ...
              (_abortRef$current2 = abortRef.current) === null || _abortRef$current2 === void 0 ? void 0 : _abortRef$current2.signal.addEventListener('abort', function () {
                reject('aborted');
                // 结束强求，并且清空loading控制
  ...
  useEffect(function () {
    ...
    if (current !== undefined && tableDataList && tableDataList.length <= pageSize) {
      var _abortRef$current3;
      (_abortRef$current3 = abortRef.current) === null || _abortRef$current3 === void 0 ? void 0 : _abortRef$current3.abort();
  ...
  // pageSize 修改后返回第一页
  useEffect(function () {
    var _abortRef$current4;
    if (!prePageSize) {
      return;
    }
    (_abortRef$current4 = abortRef.current) === null || _abortRef$current4 === void 0 ? void 0 : _abortRef$current4.abort();
    fetchListDebounce.run(false);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  useDeepCompareEffect(function () {
    var _abortRef$current5;
    (_abortRef$current5 = abortRef.current) === null || _abortRef$current5 === void 0 ? void 0 : _abortRef$current5.abort();
    fetchListDebounce.run(false);
    if (!manual) {
    ...
    return function () {
      var _abortRef$current6;
      (_abortRef$current6 = abortRef.current) === null || _abortRef$current6 === void 0 ? void 0 : _abortRef$current6.abort();
    };
  ...
  return {
    ...
    reload: function () {
      var _reload = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var _abortRef$current7;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              (_abortRef$current7 = abortRef.current) === null || _abortRef$current7 === void 0 ? void 0 : _abortRef$current7.abort();
              fetchListDebounce.cancel();
